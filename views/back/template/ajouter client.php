...
&& !empty($_POST["email"]) && !empty($_POST["adresse"]) && !empty($_POST["dateNaiss"]))
{
if(isset($_POST["id"]) && isset($_POST["cin"]) && isset($_POST["nom"]) && isset($_POST["prenom"]) 
&& isset($_POST["email"]) && isset($_POST["adresse"]) && isset($_POST["dateNaiss"])&& isset($_POST["Ajouter"]))
{
    $Client->id=$_POST['id'];
              ...
              <div class="card corona-gradient-card">
                <div class="card-body py-0 px-0 px-sm-3">
                    ...
                    <form id="formajout" name="formajout" class="form" action="" method="POST" >
                       ...
                       <td>Id : </td><td><input type="text" id="id" name="id" class="form-control"> </td>
                       </tr>
                       <tr><td>cin : </td><td><input type="text" name="cin" id="cin" class="form-control" > </td>
                       </tr>
                       ...
                       <tr><td>email : </td><td><input type="text" name="email" id="email" class="form-control"  > </td>
                       </tr>
                       <tr><td>adresse : </td><td><input type="text" name="adresse" id="adresse" class="form-control"  > </td>
                       </tr>
                       <tr><td>Date de naissance : </td><td><input type="date" name="dateNaiss" id="dateNaiss" class="form-control"  > </td></tr>
                        <tr>
