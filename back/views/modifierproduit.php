<?php
	...
	if (
		...
		if (
            ...
            $produitC->modifierproduit($user, $_GET['idProduit']);
          ...
          <div class="card-body py-0 px-0 px-sm-3">
              ...
              <div class="right_col" role="main" >
               ...
               <table class="table">
                 ...
                 <td>idProduit : </td><td><input type="text" name="idProduit" class="form-control" disabled> </td>
                 </tr>
                 <tr><td>nomPrdt : </td><td><input type="text" name="nomPrdt" class="form-control" disabled> </td>
                 </tr>
